          ...
          <form onSubmit={handleFormSubmit} className="p-6 md:p-8 bg-black text-white">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button variant="outline" className="w-full bg-zinc-900 border-zinc-800 hover:bg-zinc-800">
        ...
        <AlertDialogContent className="bg-black border border-zinc-800">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-400">
              Please confirm your registration for RocketHacks. Make sure all your information is correct before proceeding.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
